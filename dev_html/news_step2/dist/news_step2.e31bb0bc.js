...
var newsList = JSON.parse(ajax.response); //9번에서 요청했을 때 서버측의 응답을 받아오는 속성이 response임
console.log(newsList); //서버측에서 보낸 응답을 출력해보기 - Array로 변환하여 출력해줌
var ul = document.createElement("ul"); //DOM API 가지고 태그를 만드니 직관적이지 않다. DOM Tree 그려지지 않아서.
...
//# sourceMappingURL=/news_step2.e31bb0bc.js.map